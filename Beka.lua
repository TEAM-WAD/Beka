...
SUDO = SUDO
sudo_users = {SUDO,1276876278,1104660682}   
print([[
...
> CH › @Z_ZW6
> CH › @Z_ZW1
~> DEVELOPER MAIN › @A_7h_9
]])
if io.open("library/redis.lua","r") then
io.close(io.open("library/redis.lua","r"))
print("done => redis.lua")
else
io.popen("cd library && wget https://raw.githubusercontent.com/Src-Beka/Beka/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Src-Beka/Files_Beka/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevBekaW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBekaW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBekaW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBekaW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBekaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBekaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBekaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1276876278) then  
var = true  
...
local UserName = (data.username_ or "Z_ZW6")
...
Beka_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Beka_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Beka_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Beka_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@A_7h_9")  
...
--------------------------------------------------------------------------------------------------------------
function SourceBeka(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."Beka1:List:Filter"..sl)
...
if not DevBekaW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevBekaW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Beka_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌁' and DevBekaW(msg) then  
...
if text == 'تعطيل التواصل ⌁' and DevBekaW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌁' and DevBekaW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌁' and DevBekaW(msg) then  
...
if text == 'ضع كليشه ستارت ⌁' and DevBekaW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌁︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌁' and DevBekaW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌁︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌁' and DevBekaW(msg) then 
...
if text == 'تحديث السورس ⌁' and DevBekaW(msg) then 
os.execute('rm -rf Beka.lua')
os.execute('wget https://raw.githubusercontent.com/Src-Beka/Beka/main/Beka.lua')
send(msg.chat_id_, msg.id_,' *⌁︙تم تحديث السورس* \n*⌁︙لديك اخر اصدار لسورس بيكا*\n*⌁︙الاصدار » { 2.8v}*')
dofile('Beka.lua')  
end
if text == 'الاصدار ⌁' and DevBekaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌁︙اصدار سورس بيكا* \n*⌁︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌁' and DevBekaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌁︙[تحديثات البوت](t.me/Z_ZW1) \n⌁︙[قناه السورس](t.me/Z_ZW6)')
end
...
if text == 'الاحصائيات ⌁' and DevBekaW(msg) then 
...
if text == 'المشتركين ⌁' and DevBekaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌁︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌁' and DevBekaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌁︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌁") and DevBekaW(msg) then
...
if text == ("قائمه العام ⌁") and DevBekaW(msg) then
...
if text == ("قائمه الكتم العام ⌁") and DevBekaW(msg) then
...
if text=="اذاعه خاص ⌁" and msg.reply_to_message_id_ == 0 and DevBekaW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌁︙ارسل الان اذاعتك؟* \n*⌁︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌁" and msg.reply_to_message_id_ == 0 and DevBekaW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌁︙ارسل الان اذاعتك؟* \n*⌁︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌁" and msg.reply_to_message_id_ == 0 and DevBekaW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌁︙ارسل الان اذاعتك؟* \n*⌁︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌁" and msg.reply_to_message_id_ == 0  and DevBekaW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌁︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌁" and msg.reply_to_message_id_ == 0  and DevBekaW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌁' and DevBekaW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌁" and DevBekaW(msg) then
...
if text == "تنظيف الكروبات ⌁" and DevBekaW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌁︙عدد الكروبات الان » { '..#group..' }'..Bekak..''..Beka..'*\n*⌁︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevBekaW(msg) then
...
usertext = '*\n ⌁︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'Z_ZW6')..')'
status  = '\n *⌁︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevBekaW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌁︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Z_ZW6')..')'
status  = '\n*⌁︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevBekaW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevBekaW(msg) then
...
local Beka1_Msg = database:get(bot_id.."Beka1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Beka1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌁︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Z_ZW6')..') \n ⌁︙'..Beka1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Beka_Msg and not Special(msg) then  
local Beka_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Beka_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌁︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌁︙["..Beka_Msg.."] \n")
else
send(msg.chat_id_,0," *⌁︙العضو :* {["..data.first_name_.."](T.ME/Z_ZW6)}\n⌁︙["..Beka_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌁︙عذرا ↫* {["..data.first_name_.."](T.ME/Z_ZW6)}\n*⌁︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBekaW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBekaW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevBekaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌁︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevBekaW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌁︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌁" and DevBekaW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌁︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌁$") and DevBekaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌁︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌁" and DevBekaW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌁" and DevBekaW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌁︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌁" and DevBekaW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
local SOFIDEV = database:get(bot_id.."AL:Sre:stats") or "لم يتم التحديد"
send(msg.chat_id_, msg.id_,"*حاله الاضافات هي : {"..SOFIDEV.."}*\n*اذا كانت {✔} الاضافات مفعله*\n*اذا كانت {❌} الاضافات معطله*")
end
...
database:sadd(bot_id.."Beka:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Beka:blocname"..msg.chat_id_)
...
function A_7h_9_name(t1,t2)
if t2.id_ then 
name_Beka = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Beka then 
names_Beka = database:smembers(bot_id.."Beka:blocname"..msg.chat_id_) or ""
if names_Beka and names_Beka[1] then 
for i=1,#names_Beka do 
if name_Beka:match("(.*)("..names_Beka[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, A_7h_9_name)
end
...
database:set(bot_id.."Beka:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Beka:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Beka:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Beka:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Beka:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function SOFI_Bekaa_new(Beka1,Beka2)
if Beka2 and Beka2.first_name_ then 
if Beka2.first_name_:match("(.*)"..database:get(bot_id.."Beka:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Beka:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Beka_nnn = database:get(bot_id.."Beka:nump"..msg.chat_id_) or 5
local Beka_nnn2 = database:get(bot_id.."Beka:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Beka_nnn2) == tonumber(Beka_nnn) or tonumber(Beka_nnn2) > tonumber(Beka_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Beka:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌁︙عزيزي >>["..Beka2.username_.."](https://t.me/"..(Beka2.username_ or "Z_ZW6")..")\n⌁︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Beka:teh"..msg.chat_id_).."} بجانب اسمك\n⌁︙عدد المحاولات المتبقيه {"..(tonumber(Beka_nnn) - tonumber(Beka_nnn2)).."}")
end
end
end
end
bnnaGet(id, SOFI_Bekaa_new)
end
end
...
local BekaChengName = database:get(bot_id.."Beka:Cheng:Name"..data.id_)
if not data.first_name_ then 
if BekaChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BekaChengName..']')
database:del(bot_id.."Beka:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
...
database:set(bot_id.."Beka:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local BekaChengUserName = database:get(bot_id.."Beka:Cheng:UserName"..data.id_)
if not data.username_ then 
if BekaChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BekaChengUserName..']')
database:del(bot_id.."Beka:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BekaChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Beka:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BekaChengPhoto = database:get(bot_id.."Beka:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BekaChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Beka:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if BekaChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Beka:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ʙᴇᴋᴀ\n\n[⌁  ʙᴇᴋᴀ ᴄʜᴀɴɴᴇʟ](http://t.me/Z_ZW6)\n\n[⌁  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/Z_ZW1)\n\n[⌁  ʙᴇᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/A_7h_9)\n\n[⌁  ʙᴇᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/E_4Rk)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌁ sᴏᴜʀᴄʀ ʙᴇᴋᴀ',url="t.me/Z_ZW6"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Z_ZW6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevBekaW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*⌁︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Z_ZW6')..') \n*⌁︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌁︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Z_ZW6')..') \n*⌁︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ مطور سورس دراكون صوفي
if text == 'تحديث' and DevBekaW(msg) then
dofile('Beka.lua')  
send(msg.chat_id_, msg.id_, ' *⌁︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevBekaW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBekaW(msg) then  
function start_function(extra, result, success)
if BekaSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevBekaW(msg) then  
...
if BekaSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌁︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevBekaW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if BekaSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌁︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBekaW(msg) then  
function start_function(extra, result, success)
if BekaSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌁︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevBekaW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevBekaW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if BekaSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌁︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBekaW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevBekaW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevBekaW(msg) then  
...
------------------------------------------------------------------------ مطور سورس دراكون صوفي
if text == ("مسح المطورين") and DevBekaW(msg) then
...
if database:get(bot_id.."A_7h_9:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'A_7h_9:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevBekaW(msg) then
t = ' *⌁︙ملفات السورس بيكا ↓*\n*•━━━━━━━ 𝐁𝐊 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevBekaW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Src-Beka/Files_Beka/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌁︙اهلا بك في متجر ملفات بيكا*\n*⌁︙ملفات السورس ↓*\n*•━━━━━━━ 𝐁𝐊 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━━ 𝐁𝐊 ━━━━━━━•*\n *⌁︙علامة تعني { ✓ } ملف مفعل*\n *⌁︙علامة تعني { ✘ } ملف معطل*\n *⌁︙قناة سورس بيكا ↓*\n".." *⌁︙*[اضغط هنا لدخول](t.me/Z_ZW6) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevBekaW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Src-Beka/Files_Beka/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Beka.lua')  
else
send(msg.chat_id_, msg.id_," *⌁︙عذرا الملف لايدعم سورس بيكا* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevBekaW(msg) then
...
if text == "مسح الملفات" and DevBekaW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌁︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevBekaW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBekaW(msg) then  
function start_function(extra, result, success)
...
function Function_Beka(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Beka, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Beka, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌁︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'Z_ZW6')..')'
status  = '\n*⌁︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌁︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Z_ZW6')..')'
status  = '\n*⌁︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌁︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌁︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Z_ZW6')..')'
...
database:set(bot_id.."Beka1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Beka1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌁︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Beka1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Beka1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Beka1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Beka1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌁︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Beka1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Beka1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Beka1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Beka1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌁︙ارسل الكلمه الان*")  
database:set(bot_id.."Beka1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Beka1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Beka1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Beka1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Beka1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Beka1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Beka1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Beka1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Beka1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevBekaW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌁︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevBekaW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌁︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'Z_ZW6')..')'..'\n*⌁︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevBekaW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBekaW(msg) then  
...
if not database:get(bot_id..'A_7h_9:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'A_7h_9:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بيكا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بيكا')
local Beka_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..Beka_Msg[math.random(#Beka_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevBekaW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,Beka)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━━ 𝐁𝐊 ━━━━━━━•*\n"
x = 0
local list = Beka.members_
for k, v in pairs(list) do
x = x + 1
...
if BekaSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevBekaW(msg) then 
...
if text == ("ردود المطور") and DevBekaW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌁︙قائمة ردود المطور \n*•━━━━━━━ 𝐁𝐊 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevBekaW(msg) then    
send(msg.chat_id_, msg.id_,' *⌁︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevBekaW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بيكا').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevBekaW(msg) then   
...
if text == 'تعطيل المغادره' and DevBekaW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Z_ZW6')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Bekadx(msg.chat_id_, msg.id_, ' *⌁︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌁︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌁︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌁︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevBekaW(msg) then
...
{{text = '𝙱𝙴𝙺𝙰 𝚃𝙴𝙰𝙼', url="t.me/Z_ZW6"}},
{{text = 'مطور السورس', url="t.me/A_7h_9"}},
}
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʙᴇᴋᴀ',url='http://t.me/Z_ZW6'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بيكا')
...
Beka = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Beka)
...
------------------------------------------------------------------------
local BekaAbot = database:get(bot_id.."Beka1:Add:Filter:Rp2"..text..result.chat_id_)   
if BekaAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌁︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌁︙["..BekaAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Beka1_Msg = database:get(bot_id.."Beka1:Add:Filter:Rp2"..text..result.chat_id_)   
if Beka1_Msg then
send(msg.chat_id_, msg.id_," ⌁︙"..Beka1_Msg)
