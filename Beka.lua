...
SUDO = SUDO
sudo_users = {SUDO,991854306,1740828176,197399058}   
print([[
...
var = true  
elseif tonumber(user_id) == tonumber(1979399058) then
var = true 
...
inline = {
{{text = 'S𝗼U𝗿C𝗲 B𝗲K𝗮',url='http://t.me/Z_ZW1'}},
}
