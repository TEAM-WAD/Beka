...
SUDO = SUDO
sudo_users = {SUDO,1276876278,1686959673,119541395}   
print([[
...
var = true  
elseif tonumber(user_id) == tonumber(1686959673) then
var = true  
...
local UserName = (data.username_ or "Bika99")
...
usertext = '*\n ⌁︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'Bika99')..')'
status  = '\n *⌁︙تم ترقيته مطور*'
...
usertext = '\n *⌁︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Bika99')..')'
status  = '\n*⌁︙تم ترقيته مطور*'
...
if Beka1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌁︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Bika99')..') \n ⌁︙'..Beka1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *⌁︙العضو :* {["..data.first_name_.."](T.ME/Bika99)}\n⌁︙["..Beka_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌁︙عذرا ↫* {["..data.first_name_.."](T.ME/Bika99)}\n*⌁︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ʙᴇᴋᴀ\n\n[⌁  ʙᴇᴋᴀ ᴄʜᴀɴɴᴇʟ](http://t.me/Bika99)\n\n[⌁  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/Bika98)\n\n[⌁  ʙᴇᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/A_7h_9)\n\n[⌁  ʙᴇᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/ESOM8)\n\n[⌁  ʙᴏᴛ ʙᴇᴋᴀ](http://t.me/Beka66bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌁ sᴏᴜʀᴄʀ ʙᴇᴋᴀ',url="t.me/Bika99"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Bika99&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '*⌁︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Bika99')..') \n*⌁︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌁︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Bika99')..') \n*⌁︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
if database:get(bot_id.."S00F4:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'S00F4:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
local UserName = (b.username_ or "Bika99")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌁︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'Bika99')..')'
status  = '\n*⌁︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌁︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Bika99')..')'
status  = '\n*⌁︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌁︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌁︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Bika99')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌁︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'Bika99')..')'..'\n*⌁︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Bika99')..')'
local iduser = result.sender_user_id_
...
{{text = '𝙱𝙴𝙺𝙰 𝚃𝙴𝙰𝙼', url="t.me/Bika99"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = 'sᴏᴜʀᴄʀ ʙᴇᴋᴀ',url='http://t.me/Bika99'}},
}
